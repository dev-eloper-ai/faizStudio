                ...
                (
                    <>
                        ...
                        <section className='projectDetails text-center py-100'>
                            <Container>
                                <h1>MegaMover - A logistics App Logo Branding</h1>
                                <div className='mainImg mb-3'>
                                    <img src="/images/projects/7/01.png" className='img-fluid' alt="main-img" />
                                </div>
                                    ...
                                    <Col md={10}>
                                        <Row>
                                            ...
                                            <Col md={7} className='offset-md-2'>
                                                <p className='para'>Unveiling a Brand New Visual Identity Revolution for Online logistics App-MegaMover!

                                                    Elevate your app's identity with our expert branding services.

                                                    From captivating logos to compelling designs, we ensure your app stands out in the world of logistics.

                                                    Ready to make a lasting impression? Connect with us at</p>
                                            </Col>
                                        </Row>
                                    </Col>
                                </Row>
                                <div>
                                    <img src="/images/projects/7/02.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/7/04.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/7/05.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/7/06.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/7/07.png" className='img-fluid mb-3' alt="cover-img" />
                                </div>
                            </Container>
                        </section>
