                ...
                (
                    <>
                        ...
                        <section className='projectDetails text-center py-100'>
                            <Container>
                                <h1>e-Rides - Online App Platform</h1>
                                <div className='mainImg mb-3'>
                                    <img src="/images/projects/4/01.png" className='img-fluid' alt="main-img" />
                                </div>
                                    ...
                                    <Col md={10}>
                                        <Row>
                                            ...
                                            <Col md={7} className='offset-md-2'>
                                                <p className='para'>Now introduce e-rides concept in your vicinity and allow people to tour around.

                                                    Here Codiant reveals an attractive app design of the e-rides online app platform. Take a trip to its design as we pack it with thrilling features and simple navigation.

                                                    Nothing can be better than investing in an automated public bike sharing system.

                                                    Take this excellent entrepreneurial idea to corner the competitive market and help the society in creating a better tomorrow.

                                                    If you need more info about e-rides online platform design, you can mail us at</p>
                                            </Col>
                                        </Row>
                                    </Col>
                                </Row>
                                <div>
                                    <img src="/images/projects/4/02.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/4/04.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/4/05.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/4/06.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/4/07.png" className='img-fluid mb-3' alt="cover-img" />
                                </div>
                            </Container>
                        </section>
