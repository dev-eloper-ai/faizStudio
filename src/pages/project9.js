                ...
                (
                    <>
                        ...
                        <section className='projectDetails text-center py-100'>
                            <Container>
                                <h1>Quick Bites - A QSR App Logo Branding</h1>
                                <div className='mainImg mb-3'>
                                    <img src="/images/projects/9/01.png" className='img-fluid' alt="main-img" />
                                </div>
                                    ...
                                    <Col md={10}>
                                        <Row>
                                            ...
                                            <Col md={7} className='offset-md-2'>
                                                <p className='para'>Unleashing the Flavor Revolution: Feast your eyes on the UX symphony of QuickBites- A QSR App.

                                                    From savory swipes to mouthwatering microinteractions, every pixel tells a delicious digital story.

                                                    Serving seamless branding with a tint of innovation. Bon appétit, tech enthusiasts!

                                                    Hungry for your QSR success? Let's connect at</p>
                                            </Col>
                                        </Row>
                                    </Col>
                                </Row>
                                <div>
                                    <img src="/images/projects/9/02.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/9/04.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/9/05.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/9/06.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/9/07.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/9/08.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/9/09.png" className='img-fluid mb-3' alt="cover-img" />
                                </div>
                            </Container>
                        </section>
