                    ...
                    <section className='projectDetails text-center py-100'>
                        <Container>
                            ...
                            <div className='mainImg mb-3'>
                                <img src="/images/projects/12/01.png" className='img-fluid' alt="main-img" />
                            </div>
                            ...
                            <div>
                                <img src="/images/projects/12/02.png" className='img-fluid mb-3' alt="cover-img" />
                                <img src="/images/projects/12/04.png" className='img-fluid mb-3' alt="cover-img" />
                                <img src="/images/projects/12/05.png" className='img-fluid mb-3' alt="cover-img" />
                                <img src="/images/projects/12/06.png" className='img-fluid mb-3' alt="cover-img" />
                                <img src="/images/projects/12/07.png" className='img-fluid mb-3' alt="cover-img" />
                            </div>
                        </Container>
                    </section>
