                ...
                (
                    <>
                        ...
                        <section className='projectDetails text-center py-100'>
                            <Container>
                                <h1>Logo Evolution and Branding - Cannabis Delivery Project</h1>
                                <div className='mainImg mb-3'>
                                    <img src="/images/projects/2/01.png" className='img-fluid' alt="main-img" />
                                </div>
                                    ...
                                    <Col md={10}>
                                        <Row>
                                            ...
                                            <Col md={7} className='offset-md-2'>
                                                <p className='para'>With exclusively hand-picked colors, fonts and effects, the design profoundly influences “rebirth and renewal”- the nature of medical cannabis!

                                                    Reinforce your brand’s identity and make a powerful impact on how consumers perceive your brand with our brand identity design services.

                                                    To get detailed information about the Cannabis Delivery branding and other related inquiries, mail us at</p>
                                            </Col>
                                        </Row>
                                    </Col>
                                </Row>
                                <div>
                                    <img src="/images/projects/2/02.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/2/03.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/2/04.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/2/05.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/2/06.png" className='img-fluid mb-3' alt="cover-img" />
                                </div>
                            </Container>
                        </section>
