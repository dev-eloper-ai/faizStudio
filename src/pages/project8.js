                ...
                (
                    <>
                        ...
                        <section className='projectDetails text-center py-100'>
                            <Container>
                                <h1>PRIM WORK - A Logo Branding App Design</h1>
                                <div className='mainImg mb-3'>
                                    <img src="/images/projects/8/01.png" className='img-fluid' alt="main-img" />
                                </div>
                                    ...
                                    <Col md={10}>
                                        <Row>
                                            ...
                                            <Col md={7} className='offset-md-2'>
                                                <p className='para'>Dive into the essence of workspace transformation with PRIM WORK. 🚀

                                                    Get a glimpse of the logo that seamlessly integrates innovation and adherence to redefining workspaces.

                                                    It's a visionary co-working space concept designed to transform the way businesses operate.

                                                    Curious to engross your workspace with a dash of exclusive branding where every detail speaks of innovation and professionalism? 🔍🎨

                                                    Connect with us at info@codiant.com to get complete details of the PRIM WORK Project.📧</p>
                                            </Col>
                                        </Row>
                                    </Col>
                                </Row>
                                <div>
                                    <img src="/images/projects/8/02.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/8/04.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/8/05.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/8/06.png" className='img-fluid mb-3' alt="cover-img" />
                                    <img src="/images/projects/8/07.png" className='img-fluid mb-3' alt="cover-img" />
                                </div>
                            </Container>
                        </section>
